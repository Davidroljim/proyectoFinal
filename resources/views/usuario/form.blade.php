<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('contrasenya') }}
            {{ Form::text('contrasenya', $usuario->contrasenya, ['class' => 'form-control' . ($errors->has('contrasenya') ? ' is-invalid' : ''), 'placeholder' => 'Contrasenya']) }}
            {!! $errors->first('contrasenya', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('correo') }}
